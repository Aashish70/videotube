...
const toggleVideoLike = asyncHandler(async (req, res) => {
    ...
    if(like){
        ...
        return res.status(200).json(new ApiResponse(200, null, "video is liked successfully"));
    }
...
const toggleTweetLike = asyncHandler(async (req, res) => {
    ...
    if(like){
        ...
        return res.status(200).json(new ApiResponse(200, null, "tweet is liked successfully"));
    }
});
...
const toggleCommentLike = asyncHandler( async (req, res) => {
    ...
    if(like){
        ...
        await res.status(200).json(new ApiResponse(200, null, "Comment is liked successfully"));
    }
})
...
const getLikedVideos = asyncHandler(async (req, res) => {
    ...
    if(!likedVideos) throw new ApiError(404, "Something went wrong while liked videos");
